...
| 83 imported purchases still carry no macros | Open | Down from 97 after transcribing published panels on 2026-08-10. What remains is mostly snacks, spices, and variants whose panel could not be verified (So Good Barista, Slurrp Farm cookies, Milky Mist SKYR, regular Coca-Cola). Needs the "create a custom food from a package label" flow in SPEC §4.5 |
