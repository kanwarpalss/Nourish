...
2. **Live with the simplified logger for several days.** Exercise a zero-result Subway creation, 0.5-pack milk, an unbranded Open Ingredient, a saved egg-white-and-oil Meal, a today-only Meal quantity change, and weight corrections.
