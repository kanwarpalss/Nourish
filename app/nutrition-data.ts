...
export type NutritionItem = {
  ...
  fat: number;
  fiber: number;
  /** False means the pack did not print fibre; zero is used only as a conservative lower bound. */
  fiberDeclared?: boolean;
  /**
...
export const SOURCE_LINKS = {
  ...
  fssai: "https://fssai.gov.in/upload/uploadfiles/files/Chapter%202_1%20%28Dairy%20products%20and%20analogues%29.pdf",
};
...
/**
 * FSSAI defines the fat and solids-not-fat boundaries for milk grades; it does not
 * publish one universal calorie/protein/carb panel for every brand. These are therefore
 * typical category references only. The exact pack in KP's hand always wins.
 */
const fssaiGradeSource: NutritionSource = { label: "FSSAI grade definition + typical macros · confirm your pack", url: SOURCE_LINKS.fssai, trust: "Reference" };
...
const nutritionSeedItems: Array<Omit<NutritionItem, "brand" | "variant"> & { brand?: string; variant?: string }> = [
  ...
  },
  {
    ...
    brand: "Epigamia",
    variant: "Natural · legacy 90 g cup",
    amount: 90,
    unit: "g",
    calories: 64,
    protein: 7,
  ...
  },
  {
    ...
    brand: "MuscleBlaze",
    variant: "Rich Milk Chocolate · 33 g scoop",
    amount: 1,
    unit: "scoop",
    calories: 131.68,
    protein: 25,
  ...
  },
  {
    ...
    source: { label: "Amul official · 200 ml pack", url: "https://shop.amul.com/en/product/amul-high-protein-buttermilk-200-ml-or-pack-of-30", trust: "Official label" },
  },
  {
    ...
    conversions: [{ unit: "pack", basisAmount: 400, label: "1 tin" }],
    source: { label: "Amul official · current 400 g tin", url: "https://shop.amul.com/en/product/amul-high-protein-paneer-400-g-or-pack-of-2", trust: "Official label" },
  },
  ...
  { id: "cauliflower", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Chou-fleur_02.jpg/500px-Chou-fleur_02.jpg", name: "Cauliflower · raw", amount: 250, unit: "g", calories: 63, protein: 4.8, carbs: 12.4, fat: 0.7, fiber: 5, category: "Ingredient", availability: "Bengaluru produce", aliases: ["gobi", "cauliflower rice", "vegetable"], source: usdaSource },
  ...
  { id: "tomato", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Tomato_je.jpg/500px-Tomato_je.jpg", name: "Tomato · raw", amount: 100, unit: "g", calories: 18, protein: 0.9, carbs: 3.9, fat: 0.2, fiber: 1.2, category: "Ingredient", availability: "Bengaluru produce", aliases: ["tamatar", "salad", "kachumber"], source: usdaSource },
  ...
  { id: "onion", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Mixed_onions.jpg/500px-Mixed_onions.jpg", name: "Onion · raw", amount: 100, unit: "g", calories: 40, protein: 1.1, carbs: 9.3, fat: 0.1, fiber: 1.7, category: "Ingredient", availability: "Bengaluru produce", aliases: ["pyaaz", "salad", "kachumber"], source: usdaSource },
  { id: "carrot", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Vegetable-Carrot-Bundle-wStalks.jpg/500px-Vegetable-Carrot-Bundle-wStalks.jpg", name: "Carrot · raw", amount: 100, unit: "g", calories: 41, protein: 0.9, carbs: 9.6, fat: 0.2, fiber: 2.8, category: "Ingredient", availability: "Bengaluru produce", aliases: ["gajar", "vegetable"], source: usdaSource },
  { id: "green-beans", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Heaps_of_beans.jpg/500px-Heaps_of_beans.jpg", name: "Green beans · raw", amount: 100, unit: "g", calories: 31, protein: 1.8, carbs: 7, fat: 0.2, fiber: 2.7, category: "Ingredient", availability: "Bengaluru produce", aliases: ["french beans", "beans", "vegetable"], source: usdaSource },
  ...
  { id: "broccoli", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Broccoli_and_cross_section_edit.jpg/500px-Broccoli_and_cross_section_edit.jpg", name: "Broccoli · raw", amount: 100, unit: "g", calories: 34, protein: 2.8, carbs: 6.6, fat: 0.4, fiber: 2.6, category: "Ingredient", availability: "Bengaluru produce / quick commerce", aliases: ["broccoli", "vegetable"], source: usdaSource },
  { id: "pumpkin", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/500px-FrenchMarketPumpkinsB.jpg", name: "Pumpkin · raw", amount: 100, unit: "g", calories: 26, protein: 1, carbs: 6.5, fat: 0.1, fiber: 0.5, category: "Ingredient", availability: "Bengaluru produce", aliases: ["kaddu", "squash"], source: usdaSource },
  ...
  // --- Milk-grade references. They help with rough manual logging, but never auto-match a
  // commercial purchase because the legal grade does not define one universal macro panel.
  { id: "milk-toned", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Glass_of_Milk_%2833657535532%29.jpg/500px-Glass_of_Milk_%2833657535532%29.jpg", name: "Toned milk · category reference", amount: 100, unit: "ml", calories: 59, protein: 3.2, carbs: 4.8, fat: 3.0, fiber: 0, category: "Ingredient", availability: "FSSAI grade: at least 3.0% fat and 8.5% SNF; pack may differ", common: true, aliases: ["milk", "doodh", "amul taaza", "nandini"], source: fssaiGradeSource },
  { id: "milk-double-toned", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Glass_of_Milk_%2833657535532%29.jpg/500px-Glass_of_Milk_%2833657535532%29.jpg", name: "Double toned milk · category reference", amount: 100, unit: "ml", calories: 47, protein: 3.4, carbs: 5.1, fat: 1.5, fiber: 0, category: "Ingredient", availability: "FSSAI grade: at least 1.3% fat and 9.0% SNF; pack may differ", aliases: ["milk", "doodh", "low fat milk"], source: fssaiGradeSource },
  { id: "milk-skimmed", name: "Skimmed milk · category reference", amount: 100, unit: "ml", calories: 36, protein: 3.5, carbs: 5.0, fat: 0.2, fiber: 0, category: "Ingredient", availability: "FSSAI grade: no more than 0.5% fat; pack may differ", aliases: ["milk", "skim", "slim n trim", "fat free milk"], source: fssaiGradeSource },
  { id: "milk-full-cream", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Glass_of_Milk_%2833657535532%29.jpg/500px-Glass_of_Milk_%2833657535532%29.jpg", name: "Full cream milk · category reference", amount: 100, unit: "ml", calories: 88, protein: 3.4, carbs: 5.1, fat: 6.0, fiber: 0, category: "Ingredient", availability: "FSSAI grade: at least 6.0% fat and 9.0% SNF; pack may differ", aliases: ["milk", "doodh", "whole milk"], source: fssaiGradeSource },
  { id: "milk-cow-whole", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Glass_of_Milk_%2833657535532%29.jpg/500px-Glass_of_Milk_%2833657535532%29.jpg", name: "Whole cow milk · farm fresh", amount: 100, unit: "ml", calories: 73, protein: 3.3, carbs: 4.8, fat: 4.5, fiber: 0, category: "Ingredient", availability: "About 4.5% fat, unstandardised", aliases: ["milk", "cow milk", "sids farm", "akshayakalpa", "country delight"], source: ifctSource },

  // --- Curd, paneer, cheese
  { id: "curd-dahi", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Curd_Setting.jpg/500px-Curd_Setting.jpg", name: "Curd · dahi, set from toned milk", amount: 100, unit: "g", calories: 57, protein: 3.1, carbs: 4.5, fat: 3.0, fiber: 0, category: "Ingredient", availability: "Bengaluru staple", common: true, aliases: ["dahi", "yogurt", "yoghurt", "nandini curd", "sids farm curd"], source: ifctSource },
  ...
  { id: "atta-whole-wheat", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Atta_flour.jpg/500px-Atta_flour.jpg", name: "Whole wheat atta · flour", amount: 100, unit: "g", calories: 321, protein: 12.1, carbs: 69.4, fat: 1.7, fiber: 11.4, category: "Ingredient", availability: "Chakki atta, Bengaluru staple", common: true, aliases: ["atta", "wheat flour", "gehu", "chapati flour", "roti flour"], source: ifctSource },
  ...
  { id: "vermicelli-dry", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Fideo_%28coiled_vermicelli%29.JPG/500px-Fideo_%28coiled_vermicelli%29.JPG", name: "Vermicelli · roasted, dry", amount: 100, unit: "g", calories: 356, protein: 12.4, carbs: 71.5, fat: 1.5, fiber: 3.0, category: "Ingredient", availability: "Bengaluru staple", aliases: ["semiya", "sevai", "vermicelli"], source: ifctSource },
  { id: "bread-whole-wheat", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Vegan_no-knead_whole_wheat_bread_loaf%2C_September_2010.jpg/500px-Vegan_no-knead_whole_wheat_bread_loaf%2C_September_2010.jpg", name: "Whole wheat bread · 1 slice", amount: 1, unit: "piece", calories: 74, protein: 3.6, carbs: 12.3, fat: 1.0, fiber: 2.0, category: "Ingredient", availability: "About 30 g per slice", aliases: ["bread", "brown bread", "atta bread", "zero maida"], source: usdaSource },
  { id: "bread-white", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Wei%C3%9Fbrot-1.jpg/500px-Wei%C3%9Fbrot-1.jpg", name: "White or sourdough bread · 1 slice", amount: 1, unit: "piece", calories: 80, protein: 2.9, carbs: 15.0, fat: 0.7, fiber: 0.8, category: "Ingredient", availability: "About 30 g per slice", aliases: ["bread", "sourdough", "sandwich bread", "pav"], source: usdaSource },
  ...
  { id: "chickpeas-dry", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Chickpea_BNC.jpg/500px-Chickpea_BNC.jpg", name: "Chickpeas · dry, uncooked", amount: 100, unit: "g", calories: 378, protein: 20.5, carbs: 62.9, fat: 6.0, fiber: 12.2, category: "Ingredient", availability: "Bengaluru staple", aliases: ["chana", "kabuli chana", "garbanzo", "chickpea"], source: usdaSource },
  ...
  { id: "potato", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Patates.jpg/500px-Patates.jpg", name: "Potato · raw", amount: 100, unit: "g", calories: 77, protein: 2.0, carbs: 17.5, fat: 0.1, fiber: 2.2, category: "Ingredient", availability: "Bengaluru produce", aliases: ["aloo", "aloo gadde", "potato"], source: usdaSource },
  { id: "beetroot", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/Detroitdarkredbeets.png/500px-Detroitdarkredbeets.png", name: "Beetroot · raw", amount: 100, unit: "g", calories: 43, protein: 1.6, carbs: 9.6, fat: 0.2, fiber: 2.8, category: "Ingredient", availability: "Bengaluru produce", aliases: ["chukandar", "beet"], source: usdaSource },
  ...
  { id: "lettuce", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Iceberg_lettuce_in_SB.jpg/500px-Iceberg_lettuce_in_SB.jpg", name: "Lettuce · raw", amount: 100, unit: "g", calories: 15, protein: 1.4, carbs: 2.9, fat: 0.2, fiber: 1.3, category: "Ingredient", availability: "Bengaluru quick commerce", aliases: ["lettuce", "romaine", "salad leaves"], source: usdaSource },
  { id: "avocado", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Persea_americana_fruit_2.JPG/500px-Persea_americana_fruit_2.JPG", name: "Avocado · raw", amount: 100, unit: "g", calories: 160, protein: 2.0, carbs: 8.5, fat: 14.7, fiber: 6.7, category: "Ingredient", availability: "Bengaluru quick commerce", aliases: ["avocado", "butter fruit", "hass"], source: usdaSource },
  { id: "guava", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Guava_pink_fruit.jpg/500px-Guava_pink_fruit.jpg", name: "Guava · raw", amount: 100, unit: "g", calories: 68, protein: 2.6, carbs: 14.3, fat: 1.0, fiber: 5.4, category: "Ingredient", availability: "Bengaluru produce", aliases: ["amrood", "seebe hannu", "guava"], source: usdaSource },
  ...
  { id: "milkymist-greek-yogurt", imageUrl: "https://images.openfoodfacts.org/images/products/890/408/330/2292/front_en.31.400.jpg", name: "Greek yogurt", brand: "Milky Mist", variant: "Natural · 100 g cup", amount: 100, unit: "g", calories: 77.8, protein: 8, carbs: 6.5, fat: 2.2, fiber: 0, category: "Ordered", availability: "Amazon · exact 100 g barcode-backed cup", common: true, aliases: ["greek yogurt", "greek yoghurt", "milky mist", "milkymist", "curd", "dahi"], conversions: [{ unit: "pack", basisAmount: 100, label: "1 cup" }], source: labelMirror("Pack label · Open Food Facts, barcode 8904083302292", "https://world.openfoodfacts.org/product/8904083302292") },
  { id: "health-factory-protein-bread", imageUrl: "https://images.openfoodfacts.org/images/products/890/800/905/9246/front_en.8.400.jpg", name: "Zero Maida Protein Bread", brand: "The Health Factory", variant: "250 g loaf", amount: 100, unit: "g", calories: 242, protein: 15.24, carbs: 41.5, fat: 1.68, fiber: 4.88, category: "Ordered", availability: "Amazon · exact 250 g barcode-backed loaf", aliases: ["protein bread", "zero maida", "health factory", "bread"], conversions: [{ unit: "pack", basisAmount: 250, label: "1 loaf" }], source: labelMirror("Manufacturer identity + barcode-backed panel", "https://www.thehealthfactory.in/products/zero-maida-super-fibre-bread-copy") },
  { id: "cosmix-plant-protein", name: "No-Nonsense Plant Protein", brand: "Cosmix", variant: "Classic Unflavoured · 38 g scoop", amount: 1, unit: "scoop", calories: 145, protein: 23.5, carbs: 11.7, fat: 0.2, fiber: 0, category: "Ordered", availability: "Reference only; KP's Indonesian Cacao purchase is a different variant", aliases: ["cosmix", "plant protein", "vegan protein", "pea protein"], source: labelMirror("Published panel · 38 g scoop, Classic Unflavoured", "https://www.fatsecret.co.in/calories-nutrition/cosmix/no-nonsense-plant-protein/1-serving") },
  { id: "so-good-oat-unsweetened", imageUrl: "https://vegandaily.in/cdn/shop/files/40291203_5-so-good-plant-based-oat-beverage-unsweetened-creamy-rich-in-calcium-vitamins.png?v=1776155085&width=500", name: "Plant-Based Oat Beverage", brand: "So Good", variant: "Unsweetened Creamy · 200 ml carton", amount: 100, unit: "ml", calories: 59, protein: 1, carbs: 6.9, fat: 3, fiber: 0, category: "Ordered", availability: "Amazon · exact Unsweetened 200 ml carton", aliases: ["oat milk", "oat beverage", "so good", "plant milk", "dairy free milk"], conversions: [{ unit: "pack", basisAmount: 200, label: "1 carton" }], source: labelMirror("Current exact 200 ml retailer panel", "https://www.amazon.in/So-Good-Unsweetened-Preservatives-Cholesterol/dp/B0BR3RPBS5") },

  // --- Branded snacks and staples KP buys, transcribed from published panels.
  { id: "parle-g", name: "Parle-G glucose biscuits", brand: "Parle", variant: "Original · pack size not identified", amount: 100, unit: "g", calories: 454, protein: 6.9, carbs: 77.3, fat: 13, fiber: 0, category: "Ordered", availability: "Reference panel only; no purchase auto-match", aliases: ["parle g", "glucose biscuit", "biscuit", "parleg"], source: labelMirror("Published panel · Parle-G Original", "https://www.fatsecret.co.in/calories-nutrition/parle/parle-g-biscuits/100g") },
  { id: "maggi-masala-noodles", name: "2-Minute Noodles", brand: "MAGGI", variant: "Masala · 70 g cake", amount: 100, unit: "g", calories: 443, protein: 8.6, carbs: 61.4, fat: 18.6, fiber: 2.9, category: "Ordered", availability: "Reference panel only; retailer title did not prove the SKU", aliases: ["maggi", "noodles", "instant noodles", "masala noodles"], conversions: [{ unit: "pack", basisAmount: 70, label: "1 cake" }], source: labelMirror("Published panel · Masala variant", "https://www.fatsecret.co.in/calories-nutrition/maggi/2-minute-noodles/100g") },
  { id: "milkymist-skyr", name: "Skyr high-protein yogurt", brand: "Milky Mist", variant: "Plain · 700 g tub", amount: 100, unit: "g", calories: 100, protein: 12, carbs: 10, fat: 1.5, fiber: 0, category: "Ordered", availability: "Amazon · exact 700 g title; panel remains a mirror", aliases: ["skyr", "milky mist", "high protein yogurt", "icelandic yogurt"], conversions: [{ unit: "pack", basisAmount: 700, label: "1 tub" }], source: labelMirror("Published panel · Skyr Plain", "https://www.fatsecret.co.in/calories-nutrition/milky-mist/skyr-high-protein-plain-yogurt/100g") },
  { id: "cadbury-dairy-milk", name: "Dairy Milk chocolate", brand: "Cadbury", variant: "Original · 20.2 g bar", amount: 100, unit: "g", calories: 532, protein: 7.8, carbs: 60.4, fat: 29.2, fiber: 0, category: "Ordered", availability: "Reference only; purchase title did not identify this pack", aliases: ["cadbury", "dairy milk", "chocolate"], conversions: [{ unit: "pack", basisAmount: 20.2, label: "1 bar" }], source: labelMirror("Pack label · Open Food Facts, barcode 7622202245558", "https://world.openfoodfacts.org/product/7622202245558") },
  { id: "lays-potato-chips", name: "Potato Chips", brand: "Lay's", variant: "India's Magic Masala · 52 g pack", amount: 100, unit: "g", calories: 555, protein: 6.9, carbs: 51.4, fat: 35.7, fiber: 0, category: "Ordered", availability: "Reference only; purchase title did not identify this pack", aliases: ["lays", "chips", "crisps", "potato chips"], conversions: [{ unit: "pack", basisAmount: 52, label: "1 pack" }], source: labelMirror("Published panel · India's Magic Masala", "https://www.nutritionix.com/i/lays/potato-chips-indias-magic-masala/5c67b60aabe9573e67448639") },
  { id: "slurrp-farm-cookies", name: "Multigrain Cookies", brand: "Slurrp Farm", variant: "Banana Oat · 80 g pack", amount: 100, unit: "g", calories: 492, protein: 5, carbs: 70, fat: 21.32, fiber: 1.11, category: "Ordered", availability: "Reference only; other Slurrp flavours remain unmatched", aliases: ["slurrp farm", "cookies", "banana oat cookies"], conversions: [{ unit: "pack", basisAmount: 80, label: "1 pack" }], source: labelMirror("Published panel · Banana Oat variant", "https://www.amazon.in/Slurrp-Farm-Healthy-Wholegrain-Transfat/dp/B01M0YIW34") },

  // --- Generic Indian staples, spices and produce from composition tables.
  { id: "rusk-toast", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Zwieback-1.jpg/500px-Zwieback-1.jpg", name: "Rusk · bakery toast", amount: 100, unit: "g", calories: 407, protein: 13.5, carbs: 72.3, fat: 7.2, fiber: 2.5, category: "Ingredient", availability: "Bengaluru bakeries", aliases: ["rusk", "toast", "iyengar"], source: usdaSource },
  ...
  { id: "lemon", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/P1030323.JPG/500px-P1030323.JPG", name: "Lemon · raw", amount: 100, unit: "g", calories: 29, protein: 1.1, carbs: 9.3, fat: 0.3, fiber: 2.8, category: "Ingredient", availability: "Bengaluru produce", aliases: ["lemon", "nimbu", "lime"], source: usdaSource },
  ...
  { id: "mint-leaves", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Mentha_spicata-IMG_6186.jpg/500px-Mentha_spicata-IMG_6186.jpg", name: "Mint leaves · raw", amount: 100, unit: "g", calories: 44, protein: 3.3, carbs: 8.4, fat: 0.7, fiber: 6.8, category: "Ingredient", availability: "Bengaluru produce", aliases: ["mint", "pudina"], source: usdaSource },
  ...
  { id: "corn-starch", name: "Corn starch · cornflour, dry", amount: 100, unit: "g", calories: 381, protein: 0.3, carbs: 91.3, fat: 0.1, fiber: 0.9, category: "Ingredient", availability: "Baking aisle", aliases: ["corn starch", "cornflour", "corn flour"], source: usdaSource },
  { id: "kala-chana-dry", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Chickpea_BNC.jpg/500px-Chickpea_BNC.jpg", name: "Kala chana · black chickpea, dry", amount: 100, unit: "g", calories: 360, protein: 17.1, carbs: 60.9, fat: 5.3, fiber: 12, category: "Ingredient", availability: "Bengaluru staple", aliases: ["kala chana", "black chana", "bengal gram", "chana"], source: ifctSource },
  { id: "chilli-powder", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/BolivianChilePowder2.JPG/500px-BolivianChilePowder2.JPG", name: "Red chilli powder", amount: 100, unit: "g", calories: 282, protein: 12, carbs: 49.7, fat: 14.3, fiber: 34.8, category: "Ingredient", availability: "Bengaluru staple · used in grams", aliases: ["chilli powder", "lal mirch", "red chilli", "chili"], source: usdaSource },
  ...
  { id: "coca-cola-original", imageUrl: "https://www.bbassets.com/media/uploads/p/m/251023_11-coca-cola-soft-drink-original-taste.jpg", name: "Coca-Cola", brand: "Coca-Cola", variant: "Original · 750 ml PET bottle", amount: 100, unit: "ml", calories: 44, protein: 0, carbs: 10.9, fat: 0, fiber: 0, category: "Ordered", availability: "India · exact 750 ml retailer SKU", aliases: ["coke", "cola"], conversions: [{ unit: "pack", basisAmount: 750, label: "1 bottle" }], source: { label: "Coca-Cola India official panel", url: "https://www.coca-cola.com/in/en/brands/coca-cola/products-coca-cola", trust: "Official label" } },
  { id: "coca-cola-zero", imageUrl: "https://www.bbassets.com/media/uploads/p/s/40262162_2-coca-cola-soft-drink-zero-sugar-no-calories.jpg", name: "Coca-Cola", brand: "Coca-Cola", variant: "Zero Sugar · 750 ml PET bottle", amount: 100, unit: "ml", calories: 0, protein: 0, carbs: 0, fat: 0, fiber: 0, category: "Ordered", availability: "India · exact 750 ml retailer SKU", aliases: ["coke zero", "zero sugar cola"], conversions: [{ unit: "pack", basisAmount: 750, label: "1 bottle" }], source: { label: "Coca-Cola India official panel", url: "https://www.coca-cola.com/in/en/brands/coca-cola/products-coca-cola-zero-sugar", trust: "Official label" } },
  { id: "coca-cola-zero-250", imageUrl: "https://rukminim2.flixcart.com/image/480/640/xif0q/aerated-drink/y/k/d/250-na-plastic-bottle-8-coca-cola-enriched-transparent-original-imagfbympezefbhn.png?q=20", name: "Coca-Cola", brand: "Coca-Cola", variant: "Zero Sugar · 8 × 250 ml PET bottles", amount: 100, unit: "ml", calories: 0, protein: 0, carbs: 0, fat: 0, fiber: 0, category: "Ordered", availability: "India · exact retailer multipack", aliases: ["coke zero", "zero sugar cola"], conversions: [{ unit: "piece", basisAmount: 250, label: "1 bottle" }, { unit: "pack", basisAmount: 2000, label: "1 retailer pack (8 bottles)" }], source: { label: "Coca-Cola India official panel", url: "https://www.coca-cola.com/in/en/brands/coca-cola/products-coca-cola-zero-sugar", trust: "Official label" } },
  { id: "diet-coke", imageUrl: "https://www.bbassets.com/media/uploads/p/s/100401162_20-coca-cola-diet-coke-soft-drink.jpg", name: "Diet Coke", brand: "Coca-Cola", variant: "India · 300 ml can", amount: 100, unit: "ml", calories: 0, protein: 0, carbs: 0, fat: 0, fiber: 0, category: "Ordered", availability: "India · exact 300 ml retailer SKU", aliases: ["coca cola diet", "diet cola"], conversions: [{ unit: "pack", basisAmount: 300, label: "1 can" }], source: { label: "Coca-Cola India official panel", url: "https://www.coca-cola.com/in/en/brands/coca-cola/products-diet-coke", trust: "Official label" } },
  ...
  { id: "sids-farm-high-protein-milk", imageUrl: "https://sidsfarm.com/cdn/shop/files/High_Protein_Milk_Mockup_02_copy_1.png?v=1750918126&width=1946", name: "High Protein Milk", brand: "Sid's Farm", variant: "Fat-free, lactose-free · 250 ml can", amount: 100, unit: "ml", calories: 63.2, protein: 10, carbs: 5.46, fat: 0.2, fiber: 0, category: "Ordered", availability: "Amazon · exact 250 ml title", aliases: ["high protein milk", "sids farm", "sid's farm"], conversions: [{ unit: "pack", basisAmount: 250, label: "1 can" }], source: { label: "Sid's Farm official · 158 kcal and 25 g protein per can", url: "https://sidsfarm.com/products/high-protein-milk", trust: "Official label" } },
  { id: "act2-popcorn-sour-cream-cheese", name: "Ready to Eat Popcorn", brand: "ACT II", variant: "Sour Cream & Cheese · pack size not identified", amount: 100, unit: "g", calories: 496, protein: 8.3, carbs: 56, fat: 29, fiber: 11.3, category: "Ordered", availability: "Reference panel only; purchase remains unmatched", aliases: ["act ii", "popcorn", "ready to eat popcorn"], source: labelMirror("Published panel · Sour Cream & Cheese", "https://www.fatsecret.co.in/calories-nutrition/act-ii/sour-cream-cheese/100g") },
  { id: "cadbury-nutties", imageUrl: "https://images.openfoodfacts.org/images/products/762/220/203/1618/front_en.3.400.jpg", name: "Nutties chocolate", brand: "Cadbury", variant: "Original · 30 g box", amount: 100, unit: "g", calories: 511, protein: 5, carbs: 67.2, fat: 24.8, fiber: 2.5, category: "Ordered", availability: "Barcode-backed 30 g pack; size-less purchase stays unmatched", aliases: ["cadbury nutties", "nutties", "chocolate"], conversions: [{ unit: "pack", basisAmount: 30, label: "1 box" }], source: labelMirror("Pack label · Open Food Facts, barcode 7622202031618", "https://world.openfoodfacts.org/product/7622202031618") },
  { id: "weikfield-custard-powder", imageUrl: "https://weikfield.com/wp-content/uploads/2023/04/sKfd0o2LIuBLEudrXtgh.png", name: "Custard Powder", brand: "Weikfield", variant: "Vanilla · 100 g carton · dry", amount: 100, unit: "g", calories: 342, protein: 0.4, carbs: 88, fat: 0.1, fiber: 0, category: "Ordered", availability: "Amazon · exact 100 g Vanilla title", aliases: ["custard powder", "weikfield", "custard"], conversions: [{ unit: "pack", basisAmount: 100, label: "1 carton" }], source: labelMirror("Published dry-powder panel; manufacturer confirms variant", "https://weikfield.com/products/weikfield-custard/") },
  { id: "kurkure-masala-munch", name: "Namkeen", brand: "Kurkure", variant: "Masala Munch · pack size not identified", amount: 100, unit: "g", calories: 555, protein: 6, carbs: 57.3, fat: 33.6, fiber: 0, category: "Ordered", availability: "Reference panel only; purchase remains unmatched", aliases: ["kurkure", "masala munch", "namkeen"], source: labelMirror("Published panel · Masala Munch", "https://www.fatsecret.co.in/calories-nutrition/kurkure/masala-munch/100g") },
  { id: "getaway-choc-brownie-fudge-icecream", name: "High-Protein Ice Cream", brand: "Get-A-Way", variant: "Chocolate Brownie Fudge · pack size not identified", amount: 100, unit: "g", calories: 182, protein: 13.4, carbs: 13, fat: 8.5, fiber: 2.08, category: "Ordered", availability: "Reference panel only; purchase remains unmatched", aliases: ["get a way", "getaway", "ice cream", "brownie fudge"], source: labelMirror("Published panel · Chocolate Brownie Fudge", "https://www.eatthismuch.com/food/nutrition/ice-cream-chocolate-brownie-fudge,2058060/") },
  { id: "health-factory-pizza-base", name: "Zero Maida Pizza Base", brand: "The Health Factory", variant: "Pack size not identified", amount: 100, unit: "g", calories: 239.7, protein: 13.4, carbs: 43.51, fat: 1.34, fiber: 6.38, category: "Ordered", availability: "Reference panel only; purchase remains unmatched", aliases: ["pizza base", "health factory", "zero maida"], source: labelMirror("Published panel", "https://www.fatsecret.co.in/calories-nutrition/the-health-factory/zero-maida-pizza-base/1-serving") },
  { id: "tang-orange-drink-mix", name: "Instant Drink Mix", brand: "Tang", variant: "Orange · dry powder · pack size not identified", amount: 100, unit: "g", calories: 380, protein: 0, carbs: 95, fat: 0, fiber: 0, category: "Ordered", availability: "Reference panel only; purchase remains unmatched", aliases: ["tang", "drink mix", "orange drink"], source: labelMirror("Published panel · Orange dry powder", "https://tools.myfooddata.com/nutrition-facts/2577109/wt1") },
  ...
  // Branded cereals and pulses, 2026-08-14. These are bought by brand and every
  // one has a printed panel, so they are exact products rather than generic
  // reference grains. Photos are committed under public/food-images/ instead of
  // hot-linked, so the image cannot disappear when a retailer changes a URL.
  // Dry weight throughout: cooked weight roughly triples.
  { id: "fortune-poha-thick", imageUrl: "/food-images/fortune-poha-thick.jpg", name: "Poha · thick, dry", brand: "Fortune", variant: "Thick · 500 g pouch", amount: 100, unit: "g", calories: 361.3, protein: 7.4, carbs: 77.2, fat: 1.6, fiber: 4.3, category: "Ordered", availability: "Barcode-backed 500 g pouch, dry", common: true, aliases: ["poha", "flattened rice", "avalakki", "beaten rice", "chivda"], conversions: [{ unit: "serving", basisAmount: 50, label: "serving (50 g dry)" }, { unit: "pack", basisAmount: 500, label: "1 pouch" }], source: labelMirror("Pack label · Open Food Facts, barcode 8906008812817", "https://world.openfoodfacts.org/product/8906008812817") },
  { id: "bambino-vermicelli", name: "Long Cut Vermicelli", brand: "Bambino", variant: "Plain · 450 g pack · dry", amount: 100, unit: "g", calories: 347, protein: 10.5, carbs: 73.9, fat: 1, fiber: 0, fiberDeclared: false, category: "Ordered", availability: "Official 450 g variant; fibre is not printed on its panel", common: true, aliases: ["vermicelli", "semiya", "sevai", "shavige", "upma", "seviyan"], conversions: [{ unit: "serving", basisAmount: 60, label: "serving (60 g dry)" }, { unit: "pack", basisAmount: 450, label: "1 pack" }], source: { label: "Bambino official panel · fibre not declared", url: "https://bambinopasta.in/products/bambino-long-cut-vermicelli", trust: "Official label" } },
  { id: "24-mantra-kabuli-chana", imageUrl: "/food-images/24-mantra-kabuli-chana.jpg", name: "Organic Kabuli Chana · dry", brand: "24 Mantra Organic", variant: "908 g (2 lb) pouch", amount: 100, unit: "g", calories: 342.9, protein: 22.9, carbs: 60, fat: 5.7, fiber: 14.3, category: "Ordered", availability: "Barcode-backed 908 g pouch, dry", common: true, aliases: ["kabuli chana", "chickpea", "chana", "chole", "garbanzo", "organic chickpea"], conversions: [{ unit: "pack", basisAmount: 908, label: "1 pouch" }], source: labelMirror("Pack label · Open Food Facts, barcode 8904083512219 · dry weight", "https://world.openfoodfacts.org/product/8904083512219") },
  // One nutrition label for a whole cooked dish: an exact product, not a recipe.
  { id: "mtr-poha-instant", imageUrl: "/food-images/mtr-poha-instant.jpg", name: "3 Minute Breakfast Poha", brand: "MTR", variant: "60 g single-serve pouch", amount: 1, unit: "pack", calories: 149, protein: 2.9, carbs: 24.2, fat: 4.3, fiber: 1.1, category: "Ordered", availability: "Barcode-backed 60 g pouch", aliases: ["instant poha", "mtr poha", "ready to eat", "breakfast pouch"], conversions: [{ unit: "g", basisAmount: 1 / 60, label: "g of the pouch" }], source: labelMirror("Pack label · Open Food Facts, barcode 8901042967325 · whole 60 g pouch", "https://world.openfoodfacts.org/product/8901042967325") },
];
